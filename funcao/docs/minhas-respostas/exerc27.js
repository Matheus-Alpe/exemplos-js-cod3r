...
function calcularCrescimento(altura1, taxa1, altura2, taxa2) {
  if (altura1 == altura2) {
    if (taxa1 > taxa2) {
      ...
      return 'As crianças tem altura e crescimento igual.'
    }
  } else {
    if (altura1 > altura2) {
      if (taxa1 >= taxa2) {
...
console.log(calcularCrescimento(130, 4, 130, 4));
console.log(calcularCrescimento(150, 4, 130, 4));
console.log(calcularCrescimento(150, 4, 130, 5));